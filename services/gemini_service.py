...
async def parse_workout_text(text: str, telegram_date: str = None, is_edit: bool = False, existing_date: str = None) -> WorkoutParseResult:
    ...
    if is_edit and existing_date:
        ...
        5. Игнорируй любые служебные префиксы в тексте (например, "[РЕДАКТИРОВАНИЕ ТРЕНИРОВКИ...]").
        6. Извлекай только фактическое описание упражнений из сообщения пользователя.
